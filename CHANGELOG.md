...
- Published an [accessibility conformance](docs/accessibility-conformance.md) document recording the WCAG 2.2 AA claim, the scope it covers, how it is verified, and the accepted unfixed failures.
