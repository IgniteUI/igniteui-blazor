...
namespace IgniteUI.Blazor.Controls
{
	...
	if (IsPropDirty("FilterKey")) { ser.AddStringProp("filterKey", this._filterKey); }
	if (IsPropDirty("CaseSensitive")) { ser.AddBooleanProp("caseSensitive", this._caseSensitive); }
	if (IsPropDirty("MatchDiacritics")) { ser.AddBooleanProp("matchDiacritics", this._matchDiacritics); }
