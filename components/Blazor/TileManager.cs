...
public partial class IgbTileManager: BaseRendererControl {
	...
	{
	get { return this._resizeMode; }
	set { 
	                if (this._resizeMode != value || !IsPropDirty("ResizeMode")) {
	                        MarkPropDirty("ResizeMode");
	                } 
	...
	{
	get { return this._dragMode; }
	set { 
	                if (this._dragMode != value || !IsPropDirty("DragMode")) {
	                        MarkPropDirty("DragMode");
	                } 
	...
	set { 
	                if (this._columnCount != value || !IsPropDirty("ColumnCount")) {
	                        MarkPropDirty("ColumnCount");
	                } 
	...
	{
	get { return this._minColumnWidth; }
	set { 
	                if (this._minColumnWidth != value || !IsPropDirty("MinColumnWidth")) {
	                        MarkPropDirty("MinColumnWidth");
	                } 
	...
	/// </summary>
	[Parameter]
	public string? MinRowHeight 
	{
	get { return this._minRowHeight; }
	set { 
	                if (this._minRowHeight != value || !IsPropDirty("MinRowHeight")) {
	                        MarkPropDirty("MinRowHeight");
	                } 
	...
	set { 
	                if (this._gap != value || !IsPropDirty("Gap")) {
	                        MarkPropDirty("Gap");
	                } 
	                this._gap = value;
	...
	if (IsPropDirty("ResizeMode")) { ser.AddEnumProp("resizeMode", this._resizeMode); }
	if (IsPropDirty("DragMode")) { ser.AddEnumProp("dragMode", this._dragMode); }
	if (IsPropDirty("ColumnCount")) { ser.AddNumberProp("columnCount", this._columnCount); }
	if (IsPropDirty("MinColumnWidth")) { ser.AddStringProp("minColumnWidth", this._minColumnWidth); }
	if (IsPropDirty("MinRowHeight")) { ser.AddStringProp("minRowHeight", this._minRowHeight); }
	if (IsPropDirty("Gap")) { ser.AddStringProp("gap", this._gap); }
