...
namespace IgniteUI.Blazor.Controls
{
	...
	if (IsPropDirty("Url")) { ser.AddStringProp("url", this._url); }
	if (IsPropDirty("AttachmentType")) { ser.AddStringProp("attachmentType", this._attachmentType); }
	if (IsPropDirty("Thumbnail")) { ser.AddStringProp("thumbnail", this._thumbnail); }
	...
	if (IsPropDirty("Url")) { args["url"] = this._url; }
	if (IsPropDirty("AttachmentType")) { args["attachmentType"] = this._attachmentType; }
	if (IsPropDirty("Thumbnail")) { args["thumbnail"] = this._thumbnail; }
	...
	if (args.ContainsKey("url")) { this.Url = ReturnToString(args["url"]); }
	if (args.ContainsKey("attachmentType")) { this.AttachmentType = ReturnToString(args["attachmentType"]); }
	if (args.ContainsKey("thumbnail")) { this.Thumbnail = ReturnToString(args["thumbnail"]); }
