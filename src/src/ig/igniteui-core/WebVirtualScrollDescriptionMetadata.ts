...
import { WebScrollIntoViewOptionsDescriptionMetadata } from "./WebScrollIntoViewOptionsDescriptionMetadata";
...
export class WebVirtualScrollDescriptionMetadata extends Base {
	...
	private static ensureMetadata(context: TypeDescriptionContext): void {
		...
		WebScrollIntoViewOptionsDescriptionMetadata.register(context);
	}
