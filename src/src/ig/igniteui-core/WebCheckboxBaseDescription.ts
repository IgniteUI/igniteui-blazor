 ...
 * @hidden 
 */
export class WebCheckboxBaseDescription extends Description {
	static $t: Type = markType(WebCheckboxBaseDescription, 'WebCheckboxBaseDescription', (<any>Description).$type);
