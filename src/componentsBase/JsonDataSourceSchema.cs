...
namespace IgniteUI.Blazor.Controls
{
    ...
    internal class JSDataSourceSchema
    {
        ...
        [UnconditionalSuppressMessage("Trimming", "IL2075", Justification = "Data item types are supplied by the application at runtime; trimmed apps must preserve their data item types — see TRIMMING.md.")]
