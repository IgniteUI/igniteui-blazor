namespace IgniteUI.Blazor.Controls
{
    ...
    /// </remarks>
    [IgbModule<IgbColorPickerModule>]
    public partial class IgbColorPickerModule : IIgbModule
    {
        /// <summary>
        ...
        {
            ModuleLoader.Load(runtime, "WebColorPickerModule");

        }

        public static void MarkIsLoadRequested(IIgniteUIBlazor runtime)
        {
            ModuleLoader.MarkIsLoadRequested(runtime, "WebColorPickerModule");
        }

        public static bool IsLoadRequested(IIgniteUIBlazor runtime)
        {
            return ModuleLoader.IsLoadRequested(runtime, "WebColorPickerModule");
        }
    }
}
