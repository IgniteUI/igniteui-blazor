...
namespace IgniteUI.Blazor.Controls
{
    ...
    public partial class IgbTileManager : BaseRendererControl
    {
        ...
        internal override void SerializeCore(RendererSerializer ser)
        {
            ...
            if (IsPropDirty("DragMode"))
            { ser.AddEnumProp("dragMode", this._dragMode); }
            if (IsPropDirty("ColumnCount"))
            { ser.AddNumberProp("columnCount", this._columnCount); }
            if (IsPropDirty("MinColumnWidth"))
            { ser.AddStringProp("minColumnWidth", this._minColumnWidth); }
            if (IsPropDirty("MinRowHeight"))
            { ser.AddStringProp("minRowHeight", this._minRowHeight); }
            if (IsPropDirty("Gap"))
            { ser.AddStringProp("gap", this._gap); }
