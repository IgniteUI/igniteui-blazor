...
namespace IgniteUI.Blazor.Controls
{
	...
	if (IsPropDirty("Reaction")) { ser.AddStringProp("reaction", this._reaction); }
	...
	if (IsPropDirty("Message")) { args["message"] = ObjectToParam(this._message); }
	if (IsPropDirty("Reaction")) { args["reaction"] = this._reaction; }
	...
	if (args.ContainsKey("message")) { this.Message = (IgbChatMessage)ConvertReturnValue(args["message"], "ChatMessage", true); }
	if (args.ContainsKey("reaction")) { this.Reaction = ReturnToString(args["reaction"]); }
