...
namespace IgniteUI.Blazor.Controls
{
	...
	if (IsPropDirty("CurrentUserId")) { ser.AddStringProp("currentUserId", this._currentUserId); }
	if (IsPropDirty("DisableAutoScroll")) { ser.AddBooleanProp("disableAutoScroll", this._disableAutoScroll); }
	if (IsPropDirty("DisableInputAttachments")) { ser.AddBooleanProp("disableInputAttachments", this._disableInputAttachments); }
	if (IsPropDirty("IsTyping")) { ser.AddBooleanProp("isTyping", this._isTyping); }
	if (IsPropDirty("HeaderText")) { ser.AddStringProp("headerText", this._headerText); }
	if (IsPropDirty("InputPlaceholder")) { ser.AddStringProp("inputPlaceholder", this._inputPlaceholder); }
	if (IsPropDirty("Suggestions")) { ser.AddArrayProp("suggestions", this._suggestions); }
	if (IsPropDirty("SuggestionsPosition")) { ser.AddEnumProp("suggestionsPosition", this._suggestionsPosition); }
	if (IsPropDirty("StopTypingDelay")) { ser.AddNumberProp("stopTypingDelay", this._stopTypingDelay); }
	if (IsPropDirty("AdoptRootStyles")) { ser.AddBooleanProp("adoptRootStyles", this._adoptRootStyles); }
	if (IsPropDirty("Renderers")) { ser.AddSerializableProp("renderers", this._renderers); }
