...
namespace IgniteUI.Blazor.Controls
{
    public partial class IgbDatePartDeltas : BaseRendererElement
    {
        ...
        internal override void SerializeCore(RendererSerializer ser)
        {
            ...
            { ser.AddNumberProp("month", this._month); }
            if (IsPropDirty("Year"))
            { ser.AddNumberProp("year", this._year); }
            if (IsPropDirty("Hours"))
            { ser.AddNumberProp("hours", this._hours); }
            if (IsPropDirty("Minutes"))
            { ser.AddNumberProp("minutes", this._minutes); }
            if (IsPropDirty("Seconds"))
            { ser.AddNumberProp("seconds", this._seconds); }
