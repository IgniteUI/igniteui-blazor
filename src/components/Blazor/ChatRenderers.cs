...
namespace IgniteUI.Blazor.Controls
{
	...
	if (IsPropDirty("AttachmentRef")) { ser.AddStringProp("attachmentRef", this._attachmentRef); }
	if (IsPropDirty("AttachmentContentRef")) { ser.AddStringProp("attachmentContentRef", this._attachmentContentRef); }
	if (IsPropDirty("AttachmentHeaderRef")) { ser.AddStringProp("attachmentHeaderRef", this._attachmentHeaderRef); }
	if (IsPropDirty("InputRef")) { ser.AddStringProp("inputRef", this._inputRef); }
	if (IsPropDirty("InputActionsRef")) { ser.AddStringProp("inputActionsRef", this._inputActionsRef); }
	if (IsPropDirty("InputActionsEndRef")) { ser.AddStringProp("inputActionsEndRef", this._inputActionsEndRef); }
	if (IsPropDirty("InputActionsStartRef")) { ser.AddStringProp("inputActionsStartRef", this._inputActionsStartRef); }
	if (IsPropDirty("MessageRef")) { ser.AddStringProp("messageRef", this._messageRef); }
	if (IsPropDirty("MessageActionsRef")) { ser.AddStringProp("messageActionsRef", this._messageActionsRef); }
	if (IsPropDirty("MessageAttachmentsRef")) { ser.AddStringProp("messageAttachmentsRef", this._messageAttachmentsRef); }
	if (IsPropDirty("MessageContentRef")) { ser.AddStringProp("messageContentRef", this._messageContentRef); }
	if (IsPropDirty("MessageHeaderRef")) { ser.AddStringProp("messageHeaderRef", this._messageHeaderRef); }
	if (IsPropDirty("SendButtonRef")) { ser.AddStringProp("sendButtonRef", this._sendButtonRef); }
	if (IsPropDirty("SuggestionPrefixRef")) { ser.AddStringProp("suggestionPrefixRef", this._suggestionPrefixRef); }
