...
namespace IgniteUI.Blazor.Controls
{
    ...
    public partial class IgbTooltip : BaseRendererControl
    {
        ...
        internal override void SerializeCore(RendererSerializer ser)
        {
            ...
            if (IsPropDirty("WithArrow"))
            { ser.AddBooleanProp("withArrow", this._withArrow); }
            ...
            { ser.AddStringProp("showTriggers", this._showTriggers); }
            if (IsPropDirty("HideTriggers"))
            { ser.AddStringProp("hideTriggers", this._hideTriggers); }
            if (IsPropDirty("ShowDelay"))
            { ser.AddNumberProp("showDelay", this._showDelay); }
            if (IsPropDirty("HideDelay"))
            { ser.AddNumberProp("hideDelay", this._hideDelay); }
            if (IsPropDirty("Message"))
            { ser.AddStringProp("message", this._message); }
            if (IsPropDirty("Sticky"))
            { ser.AddBooleanProp("sticky", this._sticky); }
