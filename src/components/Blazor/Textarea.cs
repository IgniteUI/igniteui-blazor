...
namespace IgniteUI.Blazor.Controls
{
    ...
    public partial class IgbTextarea : BaseRendererControl
    {
        ...
        internal override void SerializeCore(RendererSerializer ser)
        {
            ...
            if (IsPropDirty("Autocapitalize"))
            { ser.AddStringProp("autocapitalize", this._autocapitalize); }
            ...
            if (IsPropDirty("Resize"))
            { ser.AddEnumProp("resize", this._resize); }
            if (IsPropDirty("Rows"))
            { ser.AddNumberProp("rows", this._rows); }
            if (IsPropDirty("Value"))
            { ser.AddStringProp("value", this._value); }
            if (IsPropDirty("Spellcheck"))
            { ser.AddBooleanProp("spellcheck", this._spellcheck); }
            if (IsPropDirty("Wrap"))
            { ser.AddEnumProp("wrap", this._wrap); }
