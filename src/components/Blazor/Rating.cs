...
namespace IgniteUI.Blazor.Controls
{
    ...
    public partial class IgbRating : BaseRendererControl
    {
        ...
        internal override void SerializeCore(RendererSerializer ser)
        {
            ...
            if (IsPropDirty("Single"))
            { ser.AddBooleanProp("single", this._single); }
            if (IsPropDirty("AllowReset"))
            { ser.AddBooleanProp("allowReset", this._allowReset); }
            ...
            if (IsPropDirty("HoverRef"))
            { ser.AddStringProp("hoverRef", this._hoverRef); }
