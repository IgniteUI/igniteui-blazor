...
/*export*/ function registerChatTemplates(params) {
  ...
  window.igRegisterScript("ChatStoryMessageHeaderScript", (ctx) => {
  ...
  window.igRegisterScript("ChatStoryMessageActionsScript", (ctx) => {
  ...
  window.igRegisterScript("ChatStoryInputActionsStartScript", () => {
    return html`<igc-icon-button variant="flat" aria-label="Voice input">🎙️</igc-icon-button>`;
  }, false);
  
  window.igRegisterScript("ChatStorySuggestionPrefixScript", () => {
