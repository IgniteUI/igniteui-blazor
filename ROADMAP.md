...
5. **[DONE]** Aligned to `igniteui-webcomponents@7.3.2` - QR code image export, Chip `Outlined`, Splitter collapsed panes and `LayoutChanged`, Tabs `SelectedTab`, Icon registration options
